...
<div style="display:block; width: 100%; margin-top: auto;">
    <div style="position: relative; color: white; font-size: 16px;">
        ...
        <div style="position: absolute; top: 20px; width: 90%; margin: 0px 50px 0px 50px;">
            <label style="font-size:13px">"Every specially coffee drink you have here at Samanko Coffee Roaster is made special from</label>
            <br>
            <label style="font-size:13px">un-roasted green beans sourced ethically from the farmer from all over the world to roasted fresh onsite on our roaster.</label>
            <br>
