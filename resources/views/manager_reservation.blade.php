        ...
        <div style="display: flex; flex-direction: column; margin: 20px 50px 20px 80px; font-size: 17px;">
            ...
            <div style="display: flex; flex-direction: row; margin-top: 5px;">
                ...
                <div style="display: flex; flex-direction: row;">
                    <div
                        style="width: 25px; height: 25px; border: 1px solid black; background-color: rgba(0, 255, 0, 0.1)">
                    </div>
                    <label style="margin-left: 5px;">Available</label>
                </div>
                <div style="display: flex; flex-direction: row; margin-left: 20px;">
                    <div
                        style="width: 25px; height: 25px; border: 1px solid black; background-color: rgba(255, 255, 0, 0.3)">
                    </div>
                    <label style="margin-left: 5px;">Booked</label>
                </div>
                <div style="display: flex; flex-direction: row; margin-left: 20px;">
                    <div
                        style="width: 25px; height: 25px; border: 1px solid black; background-color: rgba(255, 0, 0, 0.3)">
                    </div>
                    ...
                    <tr>
                        <td>
                            <div style="display: flex; flex-direction: row; line-height: 1.2">
                                <img style="width: 45px; height: 45px; border-radius: 45px;"
                        ...
                        <td>
                            <div style="display: flex; justify-content: center; align-items: center;">
                                <button
                                    style="width: 125px; height: 35px; border-radius: 25px; background-color: #392A23; border: none; color: white"
                                    data-resid="{{ $data->id }}" data-tabid="{{ $data->table_id }}"
                                    onclick="showUpdateModal(this)">Update</button>
                            </div>
                        </td>
                    </tr>
                @endforeach
    ...
    function search(searchTerm) {
        $.ajax({
            ...
            success: function(response) {
                ...
                totFeeLbl.textContent = response.totalFee.toLocaleString('id-ID', {
                    style: 'currency',
                    currency: 'IDR'
                });
            },
